//
//  WJBasicLineChartViewController.m
//  CorePlotExample
//
...
@interface WJBasicLineChartViewController ()<CPTScatterPlotDataSource, CPTScatterPlotDelegate>
{
    NSArray *_dataSource;
}
...
@implementation WJBasicLineChartViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"Basic Line Chart";
...
- (void)setPlot {
    ...
    // 设置渐变色
    CPTGradient *areaGradient = [CPTGradient gradientWithBeginningColor:LineChartColor(0.6)
                                                            endingColor:LineChartColor(0.2)];

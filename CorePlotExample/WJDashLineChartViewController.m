//
//  WJDashLineChartViewController.m
//  CorePlotExample
//
...
@interface WJDashLineChartViewController ()<CPTScatterPlotDataSource, CPTScatterPlotDelegate>
{
    NSArray *_dataSource;
}
...
@implementation WJDashLineChartViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"Dash Line Chart";
